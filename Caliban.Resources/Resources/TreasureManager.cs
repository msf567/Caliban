...
namespace Treasures.Resources
{
    ...
    public static class TreasureManager
    {
        ...
        {
            { TreasureType.WATER_PUDDLE, "Caliban.WaterPuddle.exe" },
            { TreasureType.TORN_MAP, "Caliban.TornMap.exe" },
            { TreasureType.SIMPLE_VICTORY, "Caliban.SimpleVictory.exe" },
            { TreasureType.SIMPLE, "" },
        };
            ...
            string _destFileName = "")
        {
            ...
            //D.Write("Looking for " + _assemblyName + ".Caliban.Resources." +resName);
            using (var resourceStream = thisAssembly.GetManifestResourceStream(_assemblyName + ".Caliban.Resources." + resName))
            {
        ...
        {
            var thisAssembly = Assembly.GetExecutingAssembly();
            return thisAssembly.GetManifestResourceStream("Treasures.Caliban.Resources." + _resName);
        }
        ...
        public static string GetResourceText(string _textFileName)
        {
            var thisAssembly = Assembly.GetExecutingAssembly();
            string res = "";
            using (var stream = thisAssembly.GetManifestResourceStream("Treasures.Caliban.Resources." + _textFileName))
            {
                if (stream != null)
